                ...
                <div class="col-md-5">
                    <div class="card shadow border-0 p-5">
                        ...
                        <form action="{{ route('account.processResetPassword') }}" method="post">
                            @csrf
                            <input type="hidden" name="token" id="toke" value="{{ $token }}">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="password" value="{{ old('confirm_password') }}" name="confirm_password"
                                    id="confirm_password"
                                    class="form-control @error('confirm_password') is-invalid
                                         @enderror"
                    ...
                    <div class="mt-4 text-center">
                        <p>Do not have an account? <a href="{{ route('account.login') }}">Click to Login</a></p>
                    </div>
                </div>
            </div>
